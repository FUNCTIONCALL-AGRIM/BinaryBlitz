...
const Dashboard = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // ✅ CORRECT CALL (according to your api.js)
      await request(
        "/admin/upload-quiz", // endpoint
        "POST", // method (STRING)
        payload, // body
      );
      ...
      <div className={dashboardStyles.container}>
        <div className={dashboardStyles.headerWrapper}>
          <div className={dashboardStyles.headerInner}>
            <div>
              <h1 className={dashboardStyles.title}>Binary Blitz</h1>
            </div>
          </div>
        </div>
